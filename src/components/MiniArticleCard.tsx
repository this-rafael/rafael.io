...
export default function MiniArticleCard({
  ...
  return (
    <div className="card group flex overflow-hidden h-40 transition-all duration-300 hover:border-portfolio-accent/40 hover:shadow-[0_0_20px_rgba(10,132,255,0.12)]">
      {/* Image */}
