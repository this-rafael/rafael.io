      ...
      <main className="pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="card rounded-xl p-8 border border-white/10 hover:border-portfolio-accent/50 transition-all duration-300">
            ...
            <div className="card rounded-xl p-8 border border-white/10">
